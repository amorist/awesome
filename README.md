...
- [steedos/steedos-platform](https://github.com/steedos/steedos-platform) - Enterprise Low Code DevOps Platform, Open source alterative to Salesforce DX / 华炎魔方低代码平台：可视化开发 + 元数据同步 + nodejs + amis
