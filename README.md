...
- [steedos/steedos-platform](https://github.com/steedos/steedos-platform) - 华炎魔方低代码平台：可视化开发 + 元数据驱动 + nodejs + amis /  Enterprise Low Code DevOps Platform, Open source alterative to Salesforce
