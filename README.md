...
- [VILA-Lab/ATLAS](https://github.com/VILA-Lab/ATLAS) - Principled instruction dataset on formulating effective queries and prompts for large language models (LLMs). Our paper: https://arxiv.org/abs/2312.16171
...
- [heluxjs/helux](https://github.com/heluxjs/helux) - A state library that integrates atom, signal, derive, watch and collection dep, supports fine-grained responsive updates, it is compatible with all react like frameworks (including React 18)
