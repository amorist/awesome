...
- [suyuan32/simple-admin-core](https://github.com/suyuan32/simple-admin-core) - Simple Admin是一个基于go zero开发的的分布式微服务后端管理系统脚手架，提供后台管理系统的所有基本功能，支持k8s快速部署，助力快速开发高并发微服务集群，适合学习和商用。Simple Admin is a powerful microservice framework for basic management. It is based on go-zero and supports
...
- [steedos/steedos-platform](https://github.com/steedos/steedos-platform) - 华炎魔方低代码平台，Salesforce 开源替代方案，全新支持 百度Amis。Enterprise Low Code DevOps Platform, Open source alterative to Salesforce Developer Experience (DX)..
...
- [psoho/fast-poster](https://github.com/psoho/fast-poster) - 🔥🔥🔥 fastposter海报生成器,图片生成器,电商海报编辑器,海报设计器,海报制作,海报开发。生成朋友圈分享海报并生成图片，二维码海报，图片海报，海报组件，二维码推广海报，支持 小程序 Java Python PHP Go JS https://poster.prodapi.cn/doc/
